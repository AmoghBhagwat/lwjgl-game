...
import com.amoghbhagwat.game.utils.Constants;
...
public class DummyGame implements GameLogic {
    ...
    public void update(float interval, MouseInput mouseInput) {
        // update sun position
        lightAngle += Constants.SUN_SPEED;
        if (lightAngle > 90) {
    ...
    public void render(Window window) {
        renderer.render(window, gameItems, camera, ambientLight, pointLight, directionalLight);
    }
